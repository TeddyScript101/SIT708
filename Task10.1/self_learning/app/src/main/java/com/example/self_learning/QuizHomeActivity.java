...
public class QuizHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button plansButton = findViewById(R.id.plansButton);
        plansButton.setOnClickListener(v -> {
            Intent intent = new Intent(QuizHomeActivity.this, PlansActivity.class);
        ...
        profileButton.setOnClickListener(v -> {
            Intent intent = new Intent(QuizHomeActivity.this, ProfileActivity.class);

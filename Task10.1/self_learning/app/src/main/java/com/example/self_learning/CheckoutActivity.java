...
import com.example.self_learning.viewmodel.CheckoutViewModel;
...
import com.example.self_learning.databinding.ActivityCheckoutBinding;
...
public class CheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutBinding.planNameText.setText("Selected Plan: " + planName);
        layoutBinding.amountText.setText("Amount to Pay: $" + amount);
    }
    ...
    public void requestPayment(View view) {
        ...
        int amount = getIntent().getIntExtra("amount",0);
        long dummyPriceCents = amount * 100;
        final Task<PaymentData> task = model.getLoadPaymentDataTask(dummyPriceCents);
